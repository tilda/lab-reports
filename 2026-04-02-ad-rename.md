...
- Don't do both of those at the same time. The DNS setup is too fragile to handle both changes at the same time with AD having such a heavy dependency on the resolver.
